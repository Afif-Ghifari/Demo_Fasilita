...
test('test', async ({ page }) => {
  ...
  await page.waitForTimeout(1000);
  await page.locator('select[name="details[8][skor][C2]"]').selectOption('2');
  await page.waitForTimeout(1000);
  await page.locator('select[name="details[8][skor][C5]"]').selectOption('2');
  await page.waitForTimeout(1000);
  await page.locator('select[name="details[8][skor][C3]"]').selectOption('3');
  await page.waitForTimeout(1000);
  await page.locator('select[name="details[8][skor][C6]"]').selectOption('2');
  await page.waitForTimeout(1000);
