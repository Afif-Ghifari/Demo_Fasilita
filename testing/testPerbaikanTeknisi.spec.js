...
test('test', async ({ page }) => {
    ...
    await page.waitForTimeout(1000);
    await page.getByRole('button', { name: 'Choose File' }).setInputFiles('Lenna_(test_image).png');
    await page.waitForTimeout(1000);
    await page.locator('select[name="jenis_perbaikan"]').selectOption('perbaikan');
    await page.waitForTimeout(1000);
    await page.getByRole('textbox').click();
    await page.waitForTimeout(1000);
    await page.getByRole('textbox').fill('sudah bisa');
    await page.waitForTimeout(1000);
